...
FROM mdc.db_utilizationtable where msg IS NOT NULL";
...
FROM PartCheck.dbo.utilizationtable;";
...
foreach ($differences as $difference) {
    $sqlInsertQuery = "INSERT INTO PartCheck.dbo.utilizationtable (id, [_internal_timestamp], machine_id, msg, [_internal_endtime]) 
                       VALUES (?, ?, ?, ?, ?)";
    $params = array(
