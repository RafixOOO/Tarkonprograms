...
where p.[Pozycja] !='' and p.[Pozycja] LIKE '$projekt%' and p.lock is NULL
...
) and p.[Pozycja] !='' and p.[Pozycja] LIKE '$projekt%' and p.lock is NULL
...
(select max(p1.[Id])
from [PartCheck].[dbo].[Parts] p1
where p.[Zespol]=p1.Zespol and p1.[Pozycja] !='' and p1.[Pozycja] LIKE '$projekt%') as id,
p.[Projekt] as ProjectName,
p.[Zespol] AS zespol
,(select p1.[Ilosc]
from [PartCheck].[dbo].[Parts] p1
...
where p.[Pozycja] !='' and p.[Pozycja] LIKE '$projekt%'
